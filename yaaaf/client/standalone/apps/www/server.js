...
const useHttps = process.env.YAAAF_USE_HTTPS === 'true'
...
if (useHttps) {
  ...
  console.log(`Starting HTTP server on port ${currentPort}`)
  console.log(`Access your application at: http://localhost:${currentPort}`)
}
...
// Add HTTPS options if available
if (httpsOptions) {
  serverConfig.httpsOptions = httpsOptions
}
